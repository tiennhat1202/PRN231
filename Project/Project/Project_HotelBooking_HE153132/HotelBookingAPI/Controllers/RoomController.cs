...
namespace HotelBookingAPI.Controllers
{
    ...
    public class RoomController : ControllerBase
    {
        ...
        [EnableQuery]
        [HttpGet("GetRoomForHomeCustomer")]
        public ActionResult<IEnumerable<RoomResponseHomeCustomerDTO>> GetRoomsHomeCustomer()
        {
            return Ok(_mapper.Map<IEnumerable<RoomResponseHomeCustomerDTO>>(_roomRepository.GetRoomForHomeCustomer()).AsQueryable());
        }
